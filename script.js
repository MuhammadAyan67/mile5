...
function generateResume() {
  ...
  resumeOutput.innerHTML = `
          <img src="${image}" alt="Profile Picture" style="width:120px; height:120px; margin-left : 50px;  display : flex ; align-item :
...
window.onload = function () {
  ...
  if (urlParams.has("name")) {
    ...
    resumeOutput.innerHTML = `
            <img src="${image}" alt="Profile Picture" style="width:150px; height:150px; border-radius:50%;"><br>
            <h2>${name}</h2>
            <p>Email: ${email}</p>
            <h3>Education</h3>
            <p>${education}</p>
